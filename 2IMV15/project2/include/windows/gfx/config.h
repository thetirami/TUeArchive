/* include/gfx/config._h.  Generated by configure.  */
...
/* Define if <GL/glext._h> header is available */
#define HAVE_GL_GLEXT_H 1

/* Define if <GL/glxext._h> header is available */
/* #undef HAVE_GL_GLXEXT_H */

/* Define if <GL/wglext._h> header is available */
/* #undef HAVE_GL_WGLEXT_H */

/* Define if <OpenGL/glext._h> header is available (for Apple) */
